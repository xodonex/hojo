 ...
 */
public class ArrayIndexExpr extends VarIndexExpr {
    ...
    public ArrayIndexExpr(Expression base, Expression index) {
        super(base, index);
        elemType = HojoLib.typeOf(base.getTypeC().getComponentType());
    }
    ...
    public Object xeq(Environment env) {
        ...
        return Array.get(b, idx);
    }

    @Override
    public Class getTypeC() {
        return elemType.toClass();
    }
    ...
    public Object get(Object resolvent) throws HojoException {
        ...
        return Array.get(res[0], ((Integer)res[1]).intValue());
    }

    @Override
    public Object set(Object resolvent, Object value) throws HojoException {
        Object[] res = (Object[])resolvent;
        Object result = elemType.typeCast(value);
        Array.set(res[0], ((Integer)res[1]).intValue(), result);
        return result;
    }
