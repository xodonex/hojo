 ...
 */
public class AssignOp extends BinaryExpr {

    private static final long serialVersionUID = 1L;

    public AssignOp(Expression lhs, Expression rhs) {
        super(lhs, rhs);
    }
    ...
    public Object xeq(Environment env) throws HojoException {
        ...
        return lv.set(lv.resolve(env), rhs.xeq(env));
    }
    ...
    protected String toString(HojoSyntax stx, StringUtils.Format fmt) {
        return stx.operators[OP_IDX_ASSIGN];
    }
