 ...
 */
public class AssignXchgOp extends BinaryExpr {

    private static final long serialVersionUID = 1L;

    public AssignXchgOp(Expression lhs, Expression rhs) {
        super(lhs, rhs);
    }
    ...
    public Object xeq(Environment env) throws HojoException {
        ...
        Object result = lv.get(res);
        lv.set(res, rhs.xeq(env));
        return result;
    }
    ...
    protected String toString(HojoSyntax stx, StringUtils.Format fmt) {
        return stx.operators[OP_IDX_ASSGN_XCHG];
    }
