 ...
 */
public class ConstructorExpr extends ArrayExpr {

    private static final long serialVersionUID = 1L;

    protected Constructor constr;

    public ConstructorExpr(Constructor constr, Expression[] args) {
        super(args);
        this.constr = constr;
    }
    ...
    protected Type getType0() {
        return HojoLib.typeOf(constr.getDeclaringClass());
    }
    ...
    public String toString(HojoSyntax stx, StringUtils.Format fmt,
        ...
        result.append(' ').append(ReflectUtils.className2Java(getTypeC()));
