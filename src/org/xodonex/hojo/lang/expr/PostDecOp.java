 ...
 */
public class PostDecOp extends UnaryExpr {

    private static final long serialVersionUID = 1L;

    public PostDecOp(Expression arg) {
        super(arg);
    }
    ...
    public Object xeq(Environment env) throws HojoException {
        ...
        lv.set(res, HojoLib.incDec(result, false));
        return result;
    }
    ...
    public String toString(HojoSyntax stx, StringUtils.Format fmt,
            String indent) {
        return indent + arg.toString(stx, fmt, "") + stx.operators[OP_IDX_DEC];
    }
