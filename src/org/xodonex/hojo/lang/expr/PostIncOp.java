 ...
 */
public class PostIncOp extends UnaryExpr {

    private static final long serialVersionUID = 1L;

    public PostIncOp(Expression arg) {
        super(arg);
    }
    ...
    public Object xeq(Environment env) throws HojoException {
        ...
        lv.set(res, HojoLib.incDec(result, true));
        return result;
    }
    ...
    public String toString(HojoSyntax stx, StringUtils.Format fmt,
            String indent) {
        return indent + arg.toString(stx, fmt, "") + stx.operators[OP_IDX_INC];
    }
