 ...
 */
public final class AbsOp extends UnaryOperator {

    private static final long serialVersionUID = 1L;

    private final static Operator INSTANCE = new AbsOp();
    ...
    public Object invoke(Object[] arguments) throws HojoException {
        return HojoLib.abs(ConvertUtils.toNumber(arguments[0], true));
    }

    @Override
    protected int getOpIdx() {
        return HojoConst.OP_IDX_ABS;
    }
