 ...
 */
public final class CountSeqOp extends AbstractOperator {

    private static final long serialVersionUID = 1L;

    private final static Operator INSTANCE = new CountSeqOp();
    ...
    public Class[] getParameterTypes() {
        return new Class[] { Object.class, Integer.TYPE, Function.class };
    }
    ...
    public Object invoke(Object[] arguments) throws HojoException {
        return HojoLib.countSeq(arguments[0],
    ...
    protected int getOpIdx() {
        return HojoConst.OP_IDX_COUNT_SEQ;
    }
