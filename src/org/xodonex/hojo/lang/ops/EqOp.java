 ...
 */
public final class EqOp extends AbstractOperator {

    private static final long serialVersionUID = 1L;

    private final static Operator INSTANCE = new EqOp();
    ...
    public Object invoke(Object[] arguments) throws HojoException {
        return HojoLib.eq(arguments[0], arguments[1]) ? Boolean.TRUE
                : Boolean.FALSE;
    }

    @Override
    protected int getOpIdx() {
        return HojoConst.OP_IDX_EQ;
    }
