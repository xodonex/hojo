 ...
 */
public final class GeOp extends CompareOperator {

    private static final long serialVersionUID = 1L;

    private final static Operator INSTANCE = new GeOp();
    ...
    protected Object invoke(Comparable c1, Comparable c2) {
        return HojoLib.ge(c1, c2) ? Boolean.TRUE : Boolean.FALSE;
    }

    @Override
    protected int getOpIdx() {
        return HojoConst.OP_IDX_GE;
    }
