 ...
 */
public final class HexOp extends AbstractOperator {

    private static final long serialVersionUID = 1L;

    private final static Operator INSTANCE = new HexOp();
    ...
    public Object invoke(Object[] arguments) throws HojoException {
        return HojoLib.toHexString(ConvertUtils.toNumber(arguments[0], true));
    }

    @Override
    protected int getOpIdx() {
        return HojoConst.OP_IDX_HEX;
    }
