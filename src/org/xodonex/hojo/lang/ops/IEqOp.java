 ...
 */
public final class IEqOp extends AbstractOperator {

    private static final long serialVersionUID = 1L;

    private final static Operator INSTANCE = new IEqOp();
    ...
    public Object invoke(Object[] arguments) throws HojoException {
        return arguments[0] == arguments[1] ? Boolean.TRUE : Boolean.FALSE;
    }

    @Override
    protected int getOpIdx() {
        return HojoConst.OP_IDX_IEQ;
    }
