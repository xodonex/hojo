 ...
 */
public final class IofOp extends AbstractOperator {

    private static final long serialVersionUID = 1L;

    private final static Operator INSTANCE = new IofOp();
    ...
    public Object invoke(Object[] arguments) throws HojoException {
        return HojoLib.iof(arguments[0], ConvertUtils.toClass(arguments[1]))
                ? Boolean.TRUE
                : Boolean.FALSE;
    }
