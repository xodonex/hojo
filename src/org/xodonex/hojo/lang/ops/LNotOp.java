 ...
 */
public final class LNotOp extends UnaryOperator {

    private static final long serialVersionUID = 1L;

    private final static Operator INSTANCE = new LNotOp();
    ...
    public Object invoke(Object[] arguments) throws HojoException {
        return HojoLib.lNot(ConvertUtils.toBoolObj(arguments[0], true));
    }

    @Override
    protected int getOpIdx() {
        return HojoConst.OP_IDX_LNOT;
    }
