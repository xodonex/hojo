 ...
 */
public final class NegOp extends UnaryOperator {

    private static final long serialVersionUID = 1L;

    private final static Operator INSTANCE = new NegOp();
    ...
    public Object invoke(Object[] arguments) throws HojoException {
        return HojoLib.neg(ConvertUtils.toNumber(arguments[0], true));
    }

    @Override
    protected int getOpIdx() {
        return HojoConst.OP_IDX_NEG;
    }
