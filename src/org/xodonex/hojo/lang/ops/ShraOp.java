 ...
 */
public final class ShraOp extends BitShiftOperator {

    private static final long serialVersionUID = 1L;

    private final static Operator INSTANCE = new ShraOp();
    ...
    public Number invoke(Number n, int bits) throws HojoException {
        return HojoLib.shra(n, bits);
    }

    @Override
    protected int getOpIdx() {
        return HojoConst.OP_IDX_SHRA;
    }
