 ...
 */
public final class SubsetOp extends AbstractOperator {

    private static final long serialVersionUID = 1L;

    private final static Operator INSTANCE = new SubsetOp();
    ...
    public Object invoke(Object[] arguments) throws HojoException {
        return (HojoLib.subset(ConvertUtils.toCollection(arguments[0]),
                ConvertUtils.toCollection(arguments[1]))) ? Boolean.TRUE
                        : Boolean.FALSE;
    }

    @Override
    protected int getOpIdx() {
        return HojoConst.OP_IDX_SUBSET;
    }
