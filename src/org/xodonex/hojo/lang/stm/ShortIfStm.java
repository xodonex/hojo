...
public class ShortIfStm extends ExprBlockStm {

    private static final long serialVersionUID = 1L;

    public ShortIfStm(Expression expr, Statement block) {
        super(expr, block);
    }
    ...
    public String toString(HojoSyntax stx, StringUtils.Format fmt,
            String indent) {
        return toString(stx.reserved[RES_IF - RES_BASE_ID], true, stx, fmt,
                indent).toString();
    }
