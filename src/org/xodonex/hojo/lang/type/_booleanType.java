...
public final class _booleanType extends BooleanType {

    private static final long serialVersionUID = 1L;

    private final static Type INSTANCE = new _booleanType();

    private _booleanType() {
    }
    ...
    protected Object convert(Object o) {
        return ConvertUtils.toBoolObj(o, true);
    }
