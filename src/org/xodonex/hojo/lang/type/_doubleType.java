...
public final class _doubleType extends DoubleType {

    private static final long serialVersionUID = 1L;

    private final static Type INSTANCE = new _doubleType();
    ...
    public Expression defaultCode() {
        return Const.DOUBLE_0;
    }

    @Override
    protected Object convert(Object o) {
        return ConvertUtils.toDoubleObj(o, true);
    }
