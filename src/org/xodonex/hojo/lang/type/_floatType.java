...
public final class _floatType extends FloatType {

    private static final long serialVersionUID = 1L;

    private final static Type INSTANCE = new _floatType();
    ...
    public Expression defaultCode() {
        return Const.FLOAT_0;
    }

    @Override
    protected Object convert(Object o) {
        return ConvertUtils.toFloatObj(o, true);
    }
