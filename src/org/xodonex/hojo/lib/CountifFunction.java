...
public final class CountifFunction extends StandardFunction {

    private static final long serialVersionUID = 1L;

    private final static CountifFunction instance = new CountifFunction();

    public static CountifFunction getInstance() {
        return instance;
    }
