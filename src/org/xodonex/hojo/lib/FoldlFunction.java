...
public final class FoldlFunction extends StandardFunction {

    private static final long serialVersionUID = 1L;

    private final static Class[] pTypes = { Function.class, Object.class,
            Iterator.class };
    private final static FoldlFunction instance = new FoldlFunction();

    private FoldlFunction() {
    }
    ...
    public static FoldlFunction getInstance() {
        return instance;
    }
    ...
    public Object invoke(Object[] args) {
        ...
        Iterator it = ConvertUtils.toIterator(args[2]);
